...
var style_Casa_1 = function(feature, resolution){
    ...
    var style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 6.0 + size, points: 4,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(0,253,255,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 1.52}), fill: new ol.style.Fill({color: 'rgba(78,203,199,1.0)'})}),
